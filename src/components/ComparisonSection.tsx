          ...
          <table className="w-full min-w-[1000px] border-collapse">
            <thead>
              <tr className="border-b border-border">
                <th className="p-6 text-left text-sm font-mono text-muted-foreground/70 uppercase tracking-wider w-[200px]">Capability</th>
                <th className="p-6 text-center text-sm font-bold text-brand uppercase tracking-wider bg-brand/5 border-x border-brand/20 w-[240px]">AgentTrace</th>
                <th className="p-6 text-center text-sm font-mono text-muted-foreground/70 uppercase tracking-wider w-[200px]">Frameworks<br /><span className="text-[10px] opacity-60 normal-case">(LangChain/LlamaIndex)</span></th>
                <th className="p-6 text-center text-sm font-mono text-muted-foreground/70 uppercase tracking-wider w-[180px]">Prompt Tools<br /><span className="text-[10px] opacity-60 normal-case">(LangSmith)</span></th>
                <th className="p-6 text-center text-sm font-mono text-muted-foreground/70 uppercase tracking-wider w-[180px]">Logs / APM</th>
                <th className="p-6 text-center text-sm font-mono text-muted-foreground/70 uppercase tracking-wider w-[180px]">Replay.io</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {tableData.map((row, i) => (
                <tr key={row.capability} className="group hover:bg-muted/30 transition-colors">
                  <td className="p-6 text-sm font-medium text-foreground/80 whitespace-nowrap">
                    {row.capability}
                  </td>
                  {/* AgentTrace Column - Highlighted */}
                  <td className="p-6 text-center bg-brand/[0.02] border-x border-brand/10 group-hover:bg-brand/[0.05] transition-colors relative">
